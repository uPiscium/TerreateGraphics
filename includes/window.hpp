...
class ICallable {
  public:
    virtual void operator()(Window *window) = 0;
};
...
class Window : public Object {
  ...
  public:
    ...
    /*
     * @brief: This function sets window render loop.
     * @param: renderLoop: Window render loop.
     */
    void SetRenderLoop(ICallable *renderLoop) { mRenderLoop = renderLoop; }
